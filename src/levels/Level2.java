...
public class Level2 {
    ...
    public static void main(String[] args) {
        ...
        long nbr = teachers.stream().filter(t->t.getName().startsWith("m")).count();
        /* TO DO 2: Retourner la somme des salaires de tous les enseignants Flutter (hint: mapToInt) */
        long sum = teachers.stream().filter(t->t.getSubject().equals(Subject.FLUTTER)).mapToInt(t->t.getSalary()).sum();/* TO DO 2 */;
        ...
        List<Teacher> teachers1 = teachers.stream().filter(t->t.getName().startsWith("f")).collect(Collectors.toList());/* TO DO 4 */;
        ...
        /*First way*/
        teachers.stream().filter(t->t.getName().startsWith("g")).filter(t->t.getSubject().equals(Subject.UNITY)).findFirst()/* TO DO 7 */;
        ;
        /*Second way*/
        ...
        teachers.stream().filter(t->t.getName().startsWith("s")).skip(1).findFirst()/* TO DO 8 */;
